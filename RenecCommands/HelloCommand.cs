...
namespace RenecCommands
{
	...
	public class HelloCommand : ScriptCommand
	{
		...
		public async override Tasks.Task RunCommand(object sender)
		{
			...
			var message = "Hello "+ StringMethods.ConvertObjectToString(variableMessage, variableMessage.GetType());
